...
/**
 * The original image Script surface, moved under the Image sub-tab with no
 * behaviour change: same pair permutation, same estimate, same run action.
 */
export type ImageScriptPanelProps = {
...
export function ImageScriptPanel(props: ImageScriptPanelProps) {
  ...
  return (
    <>
      <PanelHeader title="Image script" subtitle="Choose sources, then run each selected prompt pair once.">
