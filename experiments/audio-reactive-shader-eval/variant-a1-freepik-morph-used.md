# Variant A1 - Freepik Morph Prompt Used

This captures the actual A1 prompt used for the continuous morph baseline. No audio, no shader.

```text
Create one continuous 8.22 second cinematic macro video from the three reference images. Machanical movement, spining robotic moves, mechatronics.
